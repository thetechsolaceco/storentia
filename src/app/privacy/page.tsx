      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert max-w-none font-roboto space-y-8 leading-relaxed text-zinc-400">
          <section className="space-y-4">
            ...
            <p>
              Welcome to Storentia. We are committed to protecting your personal data and your
              privacy. This Privacy Policy explains how Storentia (referred to as &quot;we&quot;,
              &quot;us&quot;, or &quot;our&quot;), a platform owned and operated by{" "}
              <strong>TechSolace</strong>, collects, uses, and shares your personal information when
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <h3 className="text-base font-semibold font-hanken text-zinc-200 mb-1">
                  Account Information
                </h3>
          ...
          <section className="space-y-4">
            ...
            <p>
              We may share information only with trusted third-party service providers that help us
              operate Storentia, including but not limited to:
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                Payment processors (such as Stripe, PayPal, Razorpay, or other integrated providers)
              </li>
            ...
            <p>
              All service providers are required to maintain appropriate security measures and
          ...
          <section className="space-y-4">
            ...
            <p>
              Store and transaction-related records may be retained for regulatory, accounting, or
              security purposes where required by law.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              You may request the permanent deletion of your Storentia account and associated
              personal data at any time.
            </p>
            <p>
              To request account deletion, please contact our support team using the contact
              information provided below.
            </p>
            <p>
              Please note that certain information may be retained where required by law, regulatory
              obligations, fraud prevention measures, or legitimate business purposes.
            </p>
            <p>
              Once your deletion request is verified and processed, your account and eligible
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              this page with an updated effective date. Continued use of Storentia after such
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              including account deletion requests, please contact us:
            </p>
            <p className="text-white font-medium">
              <strong>TechSolace</strong>
              <br />
              Email:{" "}
