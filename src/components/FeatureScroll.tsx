...
const features = [
  {
    ...
    description: "Build and deploy fully functional online stores in minutes with a streamlined workflow designed for modern businesses and developers.",
    image: "/dashboard/desk1.png"
  },
  {
    title: "Built for Scale",
    description: "Manage products, orders, analytics, and multiple storefronts effortlessly with infrastructure designed to grow alongside your business.",
    image: "/dashboard/desk2.png"
  },
  {
    title: "Developer Friendly APIs",
    description: "Integrate, customize, and automate every part of your commerce experience using powerful APIs and flexible architecture.",
    image: "/dashboard/desk3.png"
  },
  {
    title: "Unified Commerce Experience",
    description: "Control your entire ecosystem from one centralized platform with seamless management across stores, customers, and payments.",
